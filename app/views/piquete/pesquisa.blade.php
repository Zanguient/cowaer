		...
		<div class="box-content no-padding">
			{{Form::open(array('class'=>'form-horizontal','id'=>"fb_pesquisa"))}}
				<div class="form-group">
					...
					<div class="col-md-4">
						<select class="form-control" id="select_retiro">
							<option value=""></option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<select class="form-control" id="filtro">
						  <option value="piquetes.nome">{{trans('geral.nome')}}</option>
						  <option value="fazendas.nome">{{trans('geral.fazenda')}}</option>
						  <option value="retiros.nome">{{trans('geral.retiro')}}</option>
						  <option value="pastagens.tipo">{{trans('geral.pastagem')}}</option>
						</select>
					</div>
      ...
      <div class="modal-body">
        {{Form::open(array('class' => 'form-horizontal ','id' => 'edicao','files' => true))}}
			<div class="form-group">
				...
				<label class="col-sm-2 control-label">*{{trans('geral.retiro')}}</label>
				<div class="col-sm-10">
					<select name="cod_retiro" id="ed_cod_retiro">
					  <option value=""></option>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select name="cod_pastagem" id="ed_cod_pastagem">
					  <option value=""></option>
					</select>
				</div>
			</div>
...
<script src="{{url('js/piquete/pesquisa.js')}}"></script>
