					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<select class="form-control" id="filtro">
							  <option value="funcionarios.nome">{{trans('geral.nome')}}</option>
							  <option value="funcionarios.cod">{{trans('geral.codigo')}}</option>
							  <option value="funcionarios.login">{{trans('geral.login')}}</option>
							</select>
						</div>
					</div>
					<div class="form-group">
